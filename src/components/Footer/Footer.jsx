...
// Composant image avec fallback élégant
function FooterImage({ src, alt, className }) {
  const [error, setError] = useState(false);
  if (error) {
    return (
      <div className={`${className} footer__img-fallback`}>
    ...
    <footer className="footer">
      ...
      <div className="footer__top">
        ...
        <div className="container footer__top-content">
          ...
          />
          <h2 className="footer__top-title">{t("footer.tagline")}</h2>
          <p className="footer__top-sub">{t("footer.madeWith")}</p>
          <div className="footer__top-ctas">
            <Link to="/boutique" className="btn btn-white btn-sm">{t("nav.boutique")}</Link>
            <Link to="/sur-mesure" className="btn footer__cta-outline btn-sm">{t("nav.surMesure")}</Link>
          </div>
        </div>
      </div>
          ...
          <div className="footer__col">
            ...
            <div className="footer__contact">
              ...
              <a href="tel:+221770720202" className="footer__contact-item">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.4 2 2 0 0 1 3.58 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.5a16 16 0 0 0 6 6l.91-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.5 16h1.42z"/>
                </svg>
                +221 770 720 202
              </a>
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          ...
          <a href="https://www.azaratti.com" className="footer__website">www.azaratti.com</a>
        </div>
      </div>
